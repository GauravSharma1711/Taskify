...
const Dashboard = () => {
 ...
 <div className=' mt-2 mb-12 border-2 rounded-lg border-white p-4 flex flex-col  '>
...
<div className=' mt-8 mb-4 border-2 rounded-lg border-white p-4 flex flex-col  '>
    <div className=' mt-4 border-2 border-white p-4 flex flex-col items-center lg:items-start justify-center '>
           <h1 className=' font-bold text-2xl' >Tasks Overview</h1>
           <p>your assigned tasks status</p>
       </div>
